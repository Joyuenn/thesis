...
experiment_id = 'finetune_AusKidTalk_scripted_spontaneous_combined_freeze_lower_6_transformer_layers_lowercase_20231030'
...
set_num_train_epochs = 159                   # Default = 3.0
...
data_train_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/combined_scripted_spontaneous_v2/AusKidTalk_combined_scripted_spontaneous_train_dataframe_shuffled_only_transcription_filepath_v2.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/combined_scripted_spontaneous_v2/AusKidTalk_combined_scripted_spontaneous_dev_dataframe_shuffled_only_transcription_filepath_v2.csv'
...
#    Therefore, fine-tuning HuBERT required a special 
...
# Load pre-trained Hubert checkpoint. The tokenizer's pad_token_id
# must be to define the model's pad_token_id or in the case of HubertForCTC
...
# The first component of HuBERT consists of a stack of CNN layers
...
print("Freezing the feature extractor layers...")
model.freeze_feature_extractor()

# Parameters of lower layers of the transformer network will not be updated during training.
# This is to prevent overfitting to the AusKidTalk training data.
# The transformer network consists of 12 layers, with 512 channels at each layer
encoder = model.base_model.encoder
num_freeze_lower_layer = 6
...
if eval_pretrained:
    ...
    model = HubertForCTC.from_pretrained(eval_model)
else:
    processor = Wav2Vec2Processor.from_pretrained(model_fp)
    model = HubertForCTC.from_pretrained(model_fp)
...
if eval_baseline:
    ...
    model = HubertForCTC.from_pretrained(baseline_model)
