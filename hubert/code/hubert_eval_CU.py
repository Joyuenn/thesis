...
experiment_id = 'hubert_eval_CU_20231101'
...
checkpoint = "/srv/scratch/z5313567/thesis/hubert/model/AusKidTalk/finetune_AusKidTalk_scripted_spontaneous_combined_lowercase_20231030"
if use_checkpoint:
...
def show_random_elements(dataset, num_examples=10):
    ...
    print(df)
show_random_elements(data["train"], num_examples=1)
