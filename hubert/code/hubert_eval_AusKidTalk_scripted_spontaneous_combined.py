...
experiment_id = 'hubert_eval_AusKidTalk_scripted_spontaneous_combined_20230927_4'
...
data_test_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/combined_scripted_spontaneous/AusKidTalk_combined_scripted_spontaneous_train_only_transcription_filepath.csv'
...
if eval_baseline:
    ...
    tokenizer = HubertForCTC.from_pretrained(baseline_model)
