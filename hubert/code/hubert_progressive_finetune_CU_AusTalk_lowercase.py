...
dataset_name = 'AusTalk'
print('dataset_name:', dataset_name)

experiment_id = 'progressive_finetune_CU_AusTalk_lowercase_20231027'
print('experiment_id:', experiment_id)

cache_name = 'AusTalk-finetune'
...
data_train_fp = '/srv/scratch/z5313567/thesis/AusTalk_local/story_sentences/full_v4_select_speaker/AusTalk_story_sentences_full_train_shuffled_dataframe_only_transcription_filepath_v4.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp ='/srv/scratch/z5313567/thesis/AusTalk_local/story_sentences/full_v4_select_speaker/AusTalk_story_sentences_full_dev_test_combined_shuffled_dataframe_only_transcription_filepath_v4.csv'
...
pretrained_mod = "/srv/scratch/z5313567/thesis/hubert/model/CU/finetune_CU_lowercase_20231026"
if use_checkpoint:
