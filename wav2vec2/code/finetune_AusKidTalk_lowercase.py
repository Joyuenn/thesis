...
experiment_id = 'finetune_AusKidTalk_scripted_spontaneous_combined_lowercase_20231029_2'
...
checkpoint = "/srv/scratch/z5313567/thesis/wav2vec2/model/AusKidTalk/finetune_AusKidTalk_scripted_lowercase_20230914/checkpoint-13000"
if use_checkpoint:
...
if not use_pretrained_tokenizer:
    ...
    # Create union of all distinct letters in train, development and test set
    # and convert resulting list into enumerated dictionary
    # Vocab includes a-z, ' , space, UNK, PAD
    vocab_list = list(set(vocabs["train"]["vocab"][0]) | set(vocabs["dev"]["vocab"][0]) | set(vocabs["test"]["vocab"][0]))
