...
dataset_name = 'CU_MyST_AusKidTalk'
print('dataset_name:', dataset_name)

experiment_id = 'finetune_CU_MyST_AusKidTalk_20230829'
print('experiment_id:', experiment_id)

cache_name = 'CU_MyST_AusKidTalk-finetune'
...
data_train_fp = '/srv/scratch/z5313567/thesis/CU_MyST_AusKidTalk_local/CU_MyST_AusKidTalk_train_15sec_only_transcription_filepath.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp = '/srv/scratch/z5313567/thesis/CU_MyST_AusKidTalk_local/CU_MyST_AusKidTalk_dev_15sec_only_transcription_filepath.csv'
print("--> data_dev_fp:", data_dev_fp)

# Path to dataframe csv for test dataset
#data_test_fp = base_fp + evaluation_name + "_local/" + evaluation_filename + ".csv"
data_test_fp = '/srv/scratch/z5313567/thesis/CU_MyST_AusKidTalk_local/CU_MyST_AusKidTalk_test_15sec_only_transcription_filepath.csv'
