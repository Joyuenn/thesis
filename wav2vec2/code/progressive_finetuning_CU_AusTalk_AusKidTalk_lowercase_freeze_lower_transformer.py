...
experiment_id = 'progressive_finetune_CU_AusTalk_AusKidTalk_lowercase_freeze_lower_3_transformer_layers_20231024'
...
pretrained_mod = '/srv/scratch/z5313567/thesis/wav2vec2/model/AusTalk/progressive_finetune_CU_AusTalk_lowercase_20231023'
if use_checkpoint:
...
num_freeze_lower_layer = math.floor(len(encoder.layers) * 0.25)
