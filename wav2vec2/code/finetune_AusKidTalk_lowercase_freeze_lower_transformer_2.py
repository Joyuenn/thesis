...
print("-->Importing pandas & numpy & math...")
import pandas as pd
import numpy as np
import math
# Use regex
...
experiment_id = 'finetune_AusKidTalk_scripted_spontaneous_combined_lowercase_freeze_lower_6_transformer_layers_20231030'
...
for n in range(num_freeze_lower_layer):
    for param in model.wav2vec2.encoder.layers[n].parameters():
