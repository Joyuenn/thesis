...
experiment_id = 'progressive_finetune_CU_AusKidTalk_lowercase_freeze_base_model_speaker651_20231016'
...
data_train_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_651/train_only_transcription_filepath.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_651/test_only_transcription_filepath.csv'
print("--> data_dev_fp:", data_dev_fp)

# Path to dataframe csv for test dataset
data_test_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_651/test_only_transcription_filepath.csv'
