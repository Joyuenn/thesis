...
model_fp = '/srv/scratch/z5313567/thesis/wav2vec2/model/OGI_American/10min/10min_model_OGI_American_20230618'
print(f'Model filepath is {model_fp}\n')
vocab_fp = '/srv/scratch/z5313567/thesis/wav2vec2/vocab/OGI_American/10min/10min_vocab_OGI_American_20230618.json'
print(f'Vocab filepath is {vocab_fp}\n')
finetuned_result_fp = '/srv/scratch/z5313567/thesis/wav2vec2/finetuned_result/OGI_American/10min/10min_result_OGI_American_20230618.csv'
