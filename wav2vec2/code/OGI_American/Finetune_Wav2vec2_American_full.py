...
print("\n------------------ Loading files... ------------------\n")
train_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_full_datasets/full_OGI_scripted_train_dataframe.csv'
print(f'Training dataset is stored at {train_df_fp}\n')
dev_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_full_datasets/full_OGI_scripted_dev_dataframe.csv'
print(f'Development dataset is stored at {dev_df_fp}\n')
test_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_full_datasets/full_OGI_scripted_test_dataframe.csv'
...
if use_checkpoint:
    checkpoint_dir = '/srv/scratch/z5313567/thesis/wav2vec2/model/OGI_American/full/full_model_OGI_American_20230620/checkpoint-18000'
