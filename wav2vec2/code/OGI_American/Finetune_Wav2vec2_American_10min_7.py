...
print("\n------------------ Loading files... ------------------\n")
train_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/10min_datasets2/OGI_scripted_train_dataframe_10min_2.csv'
print(f'Training dataset is stored at {train_df_fp}\n')
dev_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/10min_datasets2/OGI_scripted_dev_dataframe_10min_2.csv'
print(f'Development dataset is stored at {dev_df_fp}\n')
test_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/10min_datasets2/OGI_scripted_test_dataframe_10min_2.csv'
...
model_fp = '/srv/scratch/z5313567/thesis/wav2vec2/model/OGI_American/10min/10min_model_OGI_American_20230619_2'
print(f'Model filepath is {model_fp}\n')
vocab_fp = '/srv/scratch/z5313567/thesis/wav2vec2/vocab/OGI_American/10min/10min_vocab_OGI_American_20230619_2.json'
print(f'Vocab filepath is {vocab_fp}\n')
finetuned_result_fp = '/srv/scratch/z5313567/thesis/wav2vec2/finetuned_result/OGI_American/10min/10min_result_OGI_American_20230619_2.csv'
