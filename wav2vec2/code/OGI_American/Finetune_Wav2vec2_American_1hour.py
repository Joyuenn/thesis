...
print("\n------------------ Loading files... ------------------\n")
train_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/1hour_datasets/OGI_scripted_train_dataframe_1hour.csv'
print(f'Training dataset is stored at {train_df_fp}\n')
dev_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/1hour_datasets/OGI_scripted_dev_dataframe_1hour.csv'
print(f'Development dataset is stored at {dev_df_fp}\n')
test_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/1hour_datasets/OGI_scripted_test_dataframe_1hour.csv'
