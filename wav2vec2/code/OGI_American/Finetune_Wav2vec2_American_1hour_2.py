...
print("\n------------------ Loading files... ------------------\n")
train_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_1hour_datasets/1hour_OGI_scripted_train_dataframe.csv'
print(f'Training dataset is stored at {train_df_fp}\n')
dev_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_1hour_datasets/1hour_OGI_scripted_dev_dataframe.csv'
print(f'Development dataset is stored at {dev_df_fp}\n')
test_df_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_1hour_datasets/1hour_OGI_scripted_test_dataframe.csv'
...
model_fp = '/srv/scratch/z5313567/thesis/wav2vec2/model/OGI_American/1hour/1hour_model_OGI_American_20230620'
print(f'Model filepath is {model_fp}\n')
vocab_fp = '/srv/scratch/z5313567/thesis/wav2vec2/vocab/OGI_American/1hour/1hour_vocab_OGI_American_20230620.json'
print(f'Vocab filepath is {vocab_fp}\n')
finetuned_result_fp = '/srv/scratch/z5313567/thesis/wav2vec2/finetuned_result/OGI_American/1hour/1hour_result_OGI_American_20230620.csv'
