...
experiment_id = 'progressive_finetune_AusTalk_CU_AusKidTalk_lowercase_freeze_lower_9_transformer_layers_20231022'
...
pretrained_mod = '/srv/scratch/z5313567/thesis/wav2vec2/model/CU/progressive_finetune_AusTalk_CU_lowercase_20231002'
if use_checkpoint:
...
num_freeze_lower_layer = math.floor(len(encoder.layers) * 0.75)
