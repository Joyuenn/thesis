...
experiment_id = 'progressive_finetune_CU_AusTalk_AusKidTalk_lowercase_freeze_lower_12_transformer_layers_20231018'
...
num_freeze_lower_layer = math.floor(len(encoder.layers) * 1)
