...
dataset_name = 'OGI-scripted-AusKidTalk-scripted'
print('dataset_name:', dataset_name)

experiment_id = 'finetune_202307017'
print('experiment_id:', experiment_id)

cache_name = 'OGI-AusKidTalk-finetune'
...
checkpoint = "/srv/scratch/z5313567/thesis/wav2vec2/model/OGI-scripted-AusKidTalk-scripted/finetune_202307017/checkpoint-35000"
if use_checkpoint:
...
data_train_fp = '/srv/scratch/z5313567/thesis/OGI_AusKidTalk_local/scripted_OGI_scripted_AusKidTalk_train_only_transcription_filepath.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp = '/srv/scratch/z5313567/thesis/OGI_AusKidTalk_local/scripted_OGI_scripted_AusKidTalk_dev_only_transcription_filepath.csv'
print("--> data_dev_fp:", data_dev_fp)

# Path to dataframe csv for test dataset
#data_test_fp = base_fp + evaluation_name + "_local/" + evaluation_filename + ".csv"
data_test_fp = '/srv/scratch/z5313567/thesis/OGI_AusKidTalk_local/scripted_OGI_scripted_AusKidTalk_test_only_transcription_filepath.csv'
