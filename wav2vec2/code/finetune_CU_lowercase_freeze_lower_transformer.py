...
experiment_id = 'finetune_CU_4h_lowercase_freeze_lower_3_transformer_layers_20231031'
...
checkpoint = "/srv/scratch/z5313567/thesis/wav2vec2/model/CU/finetune_CU_4h_lowercase_freeze_lower_3_transformer_layers_20231031"
if use_checkpoint:
...
data_train_fp = '/srv/scratch/z5313567/thesis/CU_local/4h/CU_4h_train_dataframe_15sec_only_transcription_filepath.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp = '/srv/scratch/z5313567/thesis/CU_local/4h/CU_4h_dev_dataframe_15sec_only_transcription_filepath.csv'
