...
experiment_id = 'progressive_finetune_AusTalk_CU_AusKidTalk_lowercase_freeze_lower_6_transformer_layers_20231025'
...
num_freeze_lower_layer = math.floor(len(encoder.layers) * 0.5)
