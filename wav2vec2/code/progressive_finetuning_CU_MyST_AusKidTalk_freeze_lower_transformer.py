...
experiment_id = 'progressive_finetune_CU_MyST_AusKidTalk_freeze_lower_transformer_20230920'
...
pretrained_mod = '/srv/scratch/z5313567/thesis/wav2vec2/model/MyST/progressive_finetune_CU_MyST_20230827'
if use_checkpoint:
...
num_bottom_transformer_layers_freezed = math.floor(len(encoder.layers) * 0.25)
print(f"--> Freezing bottom {num_bottom_transformer_layers_freezed} layers of the transformer ...")
for n in range num_bottom_transformer_layers_freezed:
