...
data_train_fp = '/srv/scratch/chacmod/renee_thesis/s5/myST-OGI-TLT17_local/THESIS_C/myST-OGI-TLT17_data_finetune_light.csv'
...
data_cache_fp = '/srv/scratch/chacmod/.cache/huggingface/datasets/myST-OGI-TLT17-finetune'
print("--> data_cache_fp:", data_cache_fp)
# Path to save vocab.json
# vocab_fp = base_fp + train_name + "_local/vocab_" + experiment_id + ".json"
vocab_fp = '/srv/scratch/z5313567/thesis/wav2vec2/vocab/Renee_myST_OGI_TLT/vocab_20211016_2-base-myST-OGI-TLT17.json'
...
baseline_results_fp = '/srv/scratch/z5313567/thesis/wav2vec2/finetuned_result/Renee_myST_OGI_TLT/20211016_2-base-myST-OGI-TLT17_baseline_results.csv'
...
finetuned_results_fp = '/srv/scratch/z5313567/thesis/wav2vec2/finetuned_result/Renee_myST_OGI_TLT/20211016_2-base-myST-OGI-TLT17_finetuned_results.csv'
