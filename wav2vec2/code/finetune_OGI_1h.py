...
dataset_name = 'OGI_American_1h'
print('dataset_name:', dataset_name)

experiment_id = 'finetune_1h_20230724'
print('experiment_id:', experiment_id)
...
data_train_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_1hour_datasets/1hour_OGI_scripted_train_only_transcription_filepath.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_1hour_datasets/1hour_OGI_scripted_dev_only_transcription_filepath.csv'
print("--> data_dev_fp:", data_dev_fp)

# Path to dataframe csv for test dataset
#data_test_fp = base_fp + evaluation_name + "_local/" + evaluation_filename + ".csv"
data_test_fp = '/srv/scratch/z5313567/thesis/OGI_local/new_1hour_datasets/1hour_OGI_scripted_test_only_transcription_filepath.csv'
