...
model_fp = '/srv/scratch/z5313567/thesis/OGI_local/short_datasets/model_non_offical_OGI'
...
finetuned_result_fp = '/srv/scratch/z5313567/thesis/OGI_local/short_datasets/finetuned_result_non_offical_OGI.csv'
print(f'Finetuned result filepath is {vocab_fp}\n')
...
print('testing', dataset['train'][4]['labels'])
print('dataset is:', dataset)
