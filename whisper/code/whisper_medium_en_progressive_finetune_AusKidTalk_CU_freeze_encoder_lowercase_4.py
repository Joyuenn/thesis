...
experiment_id = 'whisper_medium_en_progressive_finetune_AusKidTalk_CU_freeze_encoder_lowercase_speaker516_20231102'
...
checkpoint = "/srv/scratch/z5313567/thesis/whisper/model/CU/whisper_medium_en_progressive_finetune_AusKidTalk_CU_freeze_encoder_lowercase_20231015/checkpoint-3500"
if use_checkpoint:
...
data_train_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_516/train_only_transcription_filepath.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_516/test_only_transcription_filepath.csv'
print("--> data_dev_fp:", data_dev_fp)

# Path to dataframe csv for test dataset
data_test_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_516/test_only_transcription_filepath.csv'
