...
experiment_id = 'AusKidTalk_scripted_finetune_20230926'
...
checkpoint = "/srv/scratch/z5313567/thesis/whisper/model/AusKidTalk/AusKidTalk_scripted_finetune_20230926/checkpoint-7000"
if use_checkpoint:
...
set_per_device_eval_batch_size = 8
print("per_device_eval_batch_size:", set_per_device_eval_batch_size)
set_predict_with_generate = True
print("predict_with_generate:", set_predict_with_generate)
set_generation_max_length = 225
print("generation_max_length:", set_predict_with_generate)
