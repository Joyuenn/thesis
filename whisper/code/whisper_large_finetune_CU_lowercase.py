...
experiment_id = 'whisper_large_finetune_CU_lowercase_20231006'
...
checkpoint = "/srv/scratch/z5313567/thesis/whisper/model/CU/whisper_small_finetune_CU_20230930/checkpoint-3000"
if use_checkpoint:
...
baseline_model = "openai/whisper-large"
...
set_per_device_eval_batch_size = 16       # Default = 8
...
pretrained_mod = "openai/whisper-large"
if use_checkpoint:
