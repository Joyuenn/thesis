...
experiment_id = 'whisper_medium_en_progressive_finetune_AusKidTalk_CU_freeze_encoder_lowercase_speaker255_20231102'
...
checkpoint = "/srv/scratch/z5313567/thesis/whisper/model/CU/whisper_medium_en_progressive_finetune_AusKidTalk_CU_freeze_encoder_lowercase_speaker255_20231102/checkpoint-2500"
if use_checkpoint:
...
data_train_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_255/train_15sec_only_transcription_filepath.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_255/test_15sec_only_transcription_filepath.csv'
print("--> data_dev_fp:", data_dev_fp)

# Path to dataframe csv for test dataset
data_test_fp = '/srv/scratch/z5313567/thesis/AusKidTalk_local/spontaneous_v2/test_speaker_255/test_15sec_only_transcription_filepath.csv'
...
pretrained_mod = "/srv/scratch/z5313567/thesis/whisper/model/AusKidTalk/whisper_medium_en_finetune_AusKidTalk_lowercase_20231005"
if use_checkpoint:
...
# Ref: https://github.com/huggingface/transformers/blob/main/src/transformers/models/whisper/modeling_whisper.py
print("Freezing the encoder layer...")
