...
experiment_id = 'whisper_medium_en_finetune_AusTalk_lowercase_20231021'
...
checkpoint = "/srv/scratch/z5313567/thesis/whisper/model/AusTalk/whisper_medium_en_finetune_AusTalk_lowercase_20231021/checkpoint-3000"
if use_checkpoint:
...
data_train_fp = '/srv/scratch/z5313567/thesis/AusTalk_local/story_sentences/full/AusTalk_story_sentences_full_train_dataframe_15sec_only_transcription_filepath.csv'
print("--> data_train_fp:", data_train_fp)

# Path to dataframe csv for test dataset
data_dev_fp ='/srv/scratch/z5313567/thesis/AusTalk_local/story_sentences/full/AusTalk_story_sentences_full_dev_dataframe_15sec_only_transcription_filepath.csv'
print("--> data_dev_fp:", data_dev_fp)

# Path to dataframe csv for test dataset
data_test_fp = '/srv/scratch/z5313567/thesis/AusTalk_local/story_sentences/full/AusTalk_story_sentences_full_test_dataframe_15sec_only_transcription_filepath.csv'
